...
import api from "./services/api"; // Ajustado o caminho já que estamos na raiz do src
...
export default function App() {
  ...
  const carregarTarefas = async () => {
    try {
      ...
      console.error(err);
      setError('Não foi possível carregar as tarefas. Verifique se o servidor Backend está rodando.');
    } finally {
      setLoading(false);
    }
  };
